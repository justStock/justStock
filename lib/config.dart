...
// For the bundled Node server, default to localhost:3000 (no /api prefix)
const String kBackendBaseUrl = String.fromEnvironment('BACKEND_URL', defaultValue: 'http://localhost:4000');
